...
import { CoeficienteDeVariacaoComponent } from "./coeficiente-de-variacao/coeficiente-de-variacao.component";

@Component({
  selector: 'app-detalhamento-dos-calculos',
  standalone: true,
  imports: [LayoutComponent, ServicesModule, TabelaComponent, CalculoDeModaComponent, CalculoDeMedianaComponent, VarianciaEDesvioPadraoComponent, CoeficienteDeVariacaoComponent],
